...
以下の組み込みブロックを用い，組み込みブロックの様々な機能を含んでいるものです．
...
LLMによるスロット抽出ブロックは，入力発話を解析し，言語理解結果を出力します．
...
| シート名   | 内容                                                     |
| ---------- | -------------------------------------------------------- |
| dialogues | タイプ毎の発話例と，その発話例から抽出されるべきスロット |
