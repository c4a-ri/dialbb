...
- Test configuration file
  ...
  - `model` (string, required)
    ...
    Model specifier. Use the form `provider:model_name`, for example `google_genai:gemini-2.0-flash-001`. OpenAI GPT models such as `gpt-5.6-luna` may omit the `openai:` prefix.
