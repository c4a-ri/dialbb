...
process the data (including user utterances) inputted at each turn of the dialog. The inputted is data copied to data called blackboard in the main block. Each block takes some of the elements of the blackboard and returns data in
