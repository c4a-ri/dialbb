...
詳細な仕様やアプリケーションの構築法は[ドキュメント](https://c4a-ri.github.io/dialbb/document-ja/build/html/)を参照して下さい．（本READMEがリリース版ではない場合は、[本READMEと同じバージョンのドキュメント](docs/files/document-ja.zip)をダウンロードしてください。）
