...
- dialbbリポジトリのテンプレート`mm_client/mm_client/config/mm_client_config.ym`を使用して作成してください
...
1. `dialbb-mm-client [my_config.yml]　※default以外のconfigファイルを使用する場合は引数にパスを指定する`
